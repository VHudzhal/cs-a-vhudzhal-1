...
import com.shpp.cs.vhudzal.HG.test.TestRunnerPanel;
import com.shpp.cs.vhudzal.HG.test.TestSuite;

public class HistogramEqualizationTests extends SimpleProgram {
    public void init() {
        TestRunnerPanel panel = new TestRunnerPanel(new TestSuite[]{new TestSuite("histogramFor Tests", new TestCase[]{new TestCase() {
        ...
        }}), new TestSuite("cumulativeSumFor Tests", new TestCase[]{new TestCase() {
            public String getName() {
                return "Result array should have proper number of entries.";
            }
        ...
        }}), new TestSuite("totalPixelsIn Tests", new TestCase[]{new TestCase() {
            public String getName() {
